...
prompts = {
    "Marketing": "As a marketing expert, analyze the following text. Identify positive and negative developments and the reasons given for these. If no reasons are given, raise a question.",
...
def analyze_pdf(pdf_path):
    ...
    with open(pdf_path, "rb") as file:
        ...
        for page_num in range(num_pages):
            ...
            print ("\n\n\n","P",page_num,"of",num_pages,":",page_title)
